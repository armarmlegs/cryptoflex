    ...
    return (
      <div class="crypto-dets">
        ...
        <p class="profile-email">Email : {this.state.User.email} </p>
         ...
         <p> article published: '{this.state.User.article.title}'</p>
        <p class="profile-crypto">My crypto : {this.state.User.favoriteCryptos.map((cryptos) => <li> <Link to={`/crypto/${cryptos}`}>{cryptos}</Link></li>)}  </p>
        <br></br>
        <br></br>
