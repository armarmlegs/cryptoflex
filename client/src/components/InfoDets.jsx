...
class InfoDets extends Component {
    ...
    render() {
      ...
      <div class="crypto-dets">
       ...
       <br></br>
       <p class="crypto-info-dets-author"> author:{this.state.article.author} </p>
       <p class="crypto-info-dets-date"> Date of publication : {this.state.article.publiDate} </p>
       </div>
       <br></br>
       <div class="crypto-info-dets-user">
       <img class="img-avatar2" src={this.state.article.userId.avatar} alt="avatar"/> <p class="crypto-info-dets-username"> Written by {this.state.article.userId.userName}, {this.state.article.userId.role} for cryptorama</p>
      </div>
      </div>
        )
